...
\address{\hfill victoria.chen.wu@gmail.com  \textbar \textbar \hspace{1 mm} github.com/vptarmigan  \textbar \textbar \hspace{1 mm} vptarmigan.wordpress.com} 

 
\begin{resume}
 
\section{EDUCATION} {\sl Bachelor of Science,} Computer Science, expected December 2014 	\hfill GPA: 3.9/4.0\\
...
%		School of Computing and Engineering \\	
		Undergraduate Research Assistant, Research Advisor: Dr. Praveen Rao
		 \begin{itemize} [leftmargin=5mm]  \itemsep -2pt % reduce space between items
		 \item  Developed framework for testing optimization algorithms for federated SPARQL queries for RDF data using Jena library
...
%		Department of Computer Science and Software Engineering  \\
		NSF REU on Smart UAVs Research Fellow, Research Advisor: Dr. Saad Biaz
                 \begin{itemize}[leftmargin=5mm]  \itemsep -2pt %reduce space between items
